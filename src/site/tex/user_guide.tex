...
\begin{itemize}
  \item \menu{File > New > Release} displays the release creation dialog to the user.
  \item The releases associated with the currently selected project will be visible by accessing the release list view inside the release tab.
\end{itemize}
