...
You can undo or redo any action using \keys{\ctrl + Z} and \keys{\ctrl + \shift + Z}. Whenever a new action is performed
you will no longer be able to redo any previously undo actions.

\noindent You can revert back to the last save point using \menu{File > Revert}. Note that this action cannot be undone.
