...
Alternatively, use the keys \keys{\ctrl + L}.
...
\begin{itemize}
  ...
  \item By using the keyboard shortcuts \key{\ctrl + 1-4}
\end{itemize}
...
\section{Quick Start}
\begin{itemize}
    \item All items can be created using \menu{file > New > *Item} or by using the keyboard shortcut which can be found
    in the appendix.
    \item All items can be edited using \key{\ctrl + E} or by right clicking on the item and selecting edit.
    \item All items can be deleted using \key{\ctrl + D} or by right clicking on the item and selecting delete.
    \item To save use either \menu{File > Save} or \key{ctrl + S}.
    \item To load an existing .json file use either \menu{File > Load} or \key{\ctrl + O} and select the file using the file chooser.
    \item Undo an action using either \menu{Edit > undo} or \key{\ctrl + Z}.
    \item Redo an action using either \menu{Edit > redo} or \key{\ctrl + \shift + Z}.
