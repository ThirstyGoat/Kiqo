...
public class DeleteEffortCommandTest {
    ...
    public void testRemoveFromModel() throws Exception {
        ...
        Assert.assertFalse("Should have been removed to the model", task.getLoggedEffort().contains(effort));
    }
    ...
    public void testAddToModel() throws Exception {
        ...
        Assert.assertFalse("Should have been removed from the model", task.getLoggedEffort().contains(effort));

        command.undo();

        Assert.assertTrue("Should be in the model", task.getLoggedEffort().contains(effort));
