...
public class AllocationDatePickerCell<Allocation> extends DatePickerCell<Allocation> {
    ...
    private void startDateValidation(LocalDate date) {
        seng302.group4.Allocation allocation = (seng302.group4.Allocation)getTableRow().getItem();
        ...
        for (final seng302.group4.Allocation a : allocation.getTeam().getAllocations()) {
            if (a == allocation) {
                continue;
            }
